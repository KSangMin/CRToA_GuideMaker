...
const PLUGIN_ROOT = 'C:/Users/KSMPC/.understand-anything-plugin';
...
const Graph = (await import(pathToFileURL(require.resolve('graphology')).href)).default;
const louvain = (await import(pathToFileURL(require.resolve('graphology-communities-louvain')).href)).default;
